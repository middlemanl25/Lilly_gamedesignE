...
#List f messages
MenuList=['Instructions','Settings', " scoreboard"]
...
while check:
    ...
    if INST:
        ...
        TitleMenu('SETTINGS')
        text1=INST_FNT2.render ('level 1', 1, (0,255,0))
        text2=INST_FNT2.render('level 2', 1, (0,255,0))
        if ((mouse_pos[0] >53 and mouse_pos[0] <311) and (mouse_pos[1] >250 and mouse_pos[1] <290)):
            MAIN=False
            INST=True
